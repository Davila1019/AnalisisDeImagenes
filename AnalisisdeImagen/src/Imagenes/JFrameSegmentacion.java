...
public class JFrameSegmentacion extends JFrame{
    ...
    public JFrameSegmentacion(String title, Image io){
        ...
        setSize(ancho,alto);
        this.imagen = AbrirImagen.toBufferedImage(io).getScaledInstance(ancho,alto,BufferedImage.TYPE_INT_RGB);
        initcomponents();
        setVisible(true);
    }
  ...
  private void initcomponents(){
        ...
        this.labelImagen = new JLabel(new ImageIcon(this.imagen));
